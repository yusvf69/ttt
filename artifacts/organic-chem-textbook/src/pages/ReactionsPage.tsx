...
import {
  BenzeneRing, Tetrahedral, DoubleBond, TripleBond,
  EthanolMolecule, SN2Diagram, WohlerExperiment,
  MarkownikovRule, SN1Diagram, EnergyDiagram,
  NewmanProjection, E2Elimination, CarbocationStability, HydrogenBonding,
} from "@/data/diagrams";
    ...
    <div className="page-enter">
      <div className="navy-gradient text-white px-6 py-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-black mb-2 chapter-heading">جميع المعادلات الكيميائية</h1>
          <p className="text-blue-200 text-sm">جميع التفاعلات من الفصول الثلاثة عشر — معادلات + رسوم توضيحية</p>
        </div>
      </div>
